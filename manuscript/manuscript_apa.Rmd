...
The R code and relevant data for statistical computing are available on the "The emotion–facial expression link (data and code)" repository from the Center for Open Science [@Dupré_Tcherkassof_2020].
