...
Conclusion
============
Despite being one on the most investigated question in affective science, the link between emotion felt and facial expression is a hot topic and no clear evidence have been found to definitely answer it. However, with the growing interest of industries and government to monitor individual's psychological states, evidences are showing that facial expressions are in reality not expressing emotions [@mckeown2013analogical]. This research aimed to provide some empirical data to the question. The subjective feeling of participants was compared with human recognition on one side and automatic recognition on the other side. The results reveals a low accuracy for both humans and automatic classifier to accurately identify the inner emotional states of these individuals based on their facial expressions. Moreover it appeared that automatic classifier obtain a higher accuracy to recognize the corresponding emotion label than humans observers are. A possible explaination is that human oberservers are usually not using emotion label to recognize emotion and this type of paradigm provides non accurate results. A second explaination would rely on the type of annotation procedure which is different of the classic paradigm in which observers are asked to attribuate a label to the video. Instead, the human observers had to annotate sequences of the video. Whereas this paradigm is longer and more complicated, it can lead to more robust results in reducing the forced-choice biais [@russell1993forced]. However this procedure can also reduce the human obersvers accuracy. 
