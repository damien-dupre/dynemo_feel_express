...
```{r confusionMatrix_hr_ar, fig.height=5, fig.cap="\\label{fig:confusionMatrix_hr_ar}Proportion of emotion labels classified by human observers which are recognized by the automatif classifier."}
