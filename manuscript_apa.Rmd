...
(ref:confusionMatrix-hr-ar) Proportion of emotion labels classified by human observers which are recognized by the automatif classifier.
(ref:confusionTable-sr-hr) Human recognition accuracy metrics for each emotion.
(ref:confusionTable-sr-ar) Autonatic recognition accuracy metrics for each emotion.
...
confusionMatrix_sr_hr_table %>%
  ...
  kableExtra::footnote(
    general_title = "",
    general = "Note. *na.* values are produced when not enough data are available to compute accuracy indicators.", 
    escape = FALSE,
